    ...
    public partial class PopulandoBD : Migration
    {
        protected override void Up(MigrationBuilder mb)
        {
            ...
            mb.Sql("INSERT INTO Produtos(Nome,Descricao,Preco,ImgUrl,Estoque,DataCadastro,CategoriaId)" +
                "Values('Vodka', 'Vodka Russa', 50.00, 'https://images.unsplash.com/photo-1613255347968-aa2aaa353976?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=726&q=80', '50', SYSDATETIME()," +
                " (Select CategoriaId from Categorias where Nome = 'Bebidas'))");
            mb.Sql("INSERT INTO Produtos(Nome,Descricao,Preco,ImgUrl,Estoque,DataCadastro,CategoriaId)" +
                "Values('Vodka', 'X-Burger', 9.00, 'https://images.unsplash.com/photo-1614891669421-964261109bb4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80', '999', SYSDATETIME()," +
                " (Select CategoriaId from Categorias where Nome = 'Lanches'))");
            mb.Sql("INSERT INTO Produtos(Nome,Descricao,Preco,ImgUrl,Estoque,DataCadastro,CategoriaId)" +
                "Values('Vodka', 'Bolo', 15.00, 'https://images.unsplash.com/photo-1623888884234-cde757b501dc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80', '8', SYSDATETIME()," +
